    ...
    public class CruiseControlMod : Mod
    {
        ...
        public override void OnLoad()
        {
            ...
            {                
                ...
                Trigger trigger = new Trigger("ccPanelTrigger", _parent, new Vector3(0.112f, 0.042f, 0.016f), Quaternion.Euler(0, 0, 80.00001f), new Vector3(0.1f, 0.1f, 0.1f), true);
                this.cruiseControlPanel = new CruiseControlPanel(ccPanel_partSaveInfo, ccPanel, _parent, trigger, new Vector3(0.112f, 0.042f, 0.016f), Quaternion.Euler(0, 0, 80.00001f));
